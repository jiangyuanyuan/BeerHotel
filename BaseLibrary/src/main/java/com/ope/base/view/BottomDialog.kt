...
private constructor(builder: Builder, context: Context) : Dialog(context, R.style.AlertDialogStyle) {
    ...
    private var yesOnclickListener: ((dialog:BottomDialog, message:String)->Unit?)? = null
    private var noOnclickListener: ((dialog:BottomDialog)->Unit?)? = null


    fun setYesListener(mYesOnclickListener: (dialog:BottomDialog, message:String)->Unit) :BottomDialog{
        this.yesOnclickListener = mYesOnclickListener
        return this
    }

    fun setNoListener(mNoOnclickListener: (dialog:BottomDialog)->Unit):BottomDialog {
    ...
    init {
     ...
     class Builder(private val context: Context) {
         ...
         var mYesOnclickListener: ((dialog:BottomDialog, message:String)->Unit?)? = null
         var mNoOnclickListener: ((dialog:BottomDialog)->Unit?)? = null
        ...
        fun setPositiveButton(mOnclickListener: (dialog:BottomDialog, message:String)->Unit): Builder {
            this.mYesOnclickListener = mOnclickListener
            return this
        }

        fun setNegativeButton(mOnclickListener: (dialog:BottomDialog)->Unit): Builder {
        ...
        fun build(): BottomDialog {
            ...
            val dialog =BottomDialog(this, context)
    ...
    private fun initEvent() {
        ...
        yes.setOnClickListener {
            yesOnclickListener?.invoke(this@BottomDialog, message.data[message.currentItemPosition].toString())
        }
        //设置取消按钮被点击后，向外界提供监听
        no.setOnClickListener {
                noOnclickListener?.invoke(this@BottomDialog)
        }
